...
const Personality = () => {
  ...
  return (
    <section id="personality" className="py-16 relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-emerald-50">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-12">
          <motion.h2 className="text-4xl md:text-6xl font-black mb-4 bg-gradient-to-r from-slate-900 via-purple-500 to-emerald-600 bg-clip-text text-transparent">
            Ultimate Versatility
          </motion.h2>
          <motion.p className="text-lg md:text-xl font-light text-neutral-700 max-w-2xl mx-auto px-6 py-3 rounded-2xl bg-white/90 backdrop-blur">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-white/10 to-white/40 backdrop-blur-sm" />
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-9 gap-3 justify-items-center max-w-5xl mx-auto">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="group relative p-4 bg-gradient-to-br from-white/95 via-neutral-50/90 rounded-xl border shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-400 flex flex-col items-center justify-center min-w-[110px] max-w-[140px] h-[85px]"
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity bg-white/80 backdrop-blur-sm rounded-xl" />
              <div className="relative z-10 flex flex-col items-center gap-1 text-center w-full px-1">
                ...
                <span className="font-black text-sm leading-tight break-words tracking-tight px-1">
                  {skill.name}
                </span>
              </div>
            </motion.div>
